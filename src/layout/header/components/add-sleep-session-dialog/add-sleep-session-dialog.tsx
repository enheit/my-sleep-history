                ...
                <div className="flex flex-col gap-4 mt-8">
                    <div className="flex gap-4">
                        <div className="flex grow flex-col gap-2">
                            ...
                            <input id="in-bed-at" type="datetime-local" className="px-4 py-2 rounded-xl border border-gray-100 bg-transparent dark:text-gray-100" />
                        </div>

                        <div className="flex grow flex-col gap-2">
                            <label htmlFor="woke-up-at" className="dark:text-gray-100">Woke up at</label>
                            <input id="woke-up-at" type="datetime-local" className="px-4 py-2 rounded-xl border border-gray-100 bg-transparent dark:text-gray-100" />
                        </div>
                    </div>
